...
/* Nombre maximal de revoit de packet*/
#define NB_MAX_TRANS 50

/* ************************************** */
/* Fonctions utilitaires couche transport */
/* ************************************** */

/*genere un somme de controle*/
uint8_t generer_checksum(paquet_t p);

/*verifie la somme de controle du paquet passer en parametre*/
int verifier_checksum(paquet_t p);

/*incremente avec un modulo SEQ_NUM_SIZE*/
int inc(int i);

/*transforme les service de la coucher application en type de paquet de la couche transport*/
int type_app_to_type_trans(int type);

/*transforme les type de paquet de la couche transport en service de la coucher application*/
